hello user
<a href="{{ route('user.userDeliveryPlaceRequest') }}">userDeliveryPlaceRequest</a>
<a href="{{ route('user.userDeliveryRequest') }}">userDeliveryRequest</a>
<a href="{{ route('user.userDeliveryRequestList') }}">userDeliveryRequestList</a>
...
<a href="{{ route('user.userReceiveNoticeCompleteDelivery') }}">userReceiveNoticeCompleteDelivery</a>
<a href="{{ route('user.userWithdraw') }}">userWithdraw</a>