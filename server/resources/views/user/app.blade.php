    ...
    <body>
        ...
        <div class="side">
            @if ($currentPage === 'userDeliveryRequestList')
                <div class="current"><p><a href="{{ route('user.userDeliveryRequestList') }}">宅配依頼一覧</a></p></div>
            @else
                <p><a href="{{ route('user.userDeliveryRequestList') }}">宅配依頼一覧</a></p>
            @endif
            @if ($currentPage === 'userDeliveryPlaceRequest')
                <div class="current"><p><a href="{{ route('user.userDeliveryPlaceRequest') }}">宅配場所登録</a></p></div>
            @else
                <p><a href="{{ route('user.userDeliveryPlaceRequest') }}">宅配場所登録</a></p>
            @endif
            @if ($currentPage === 'userDeliveryRequest')
                <div class="current"><p><a href="{{ route('user.userDeliveryRequest') }}">宅配依頼</a></p></div>
            @else
