...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('coop_location', function (Blueprint $table) {
            ...
            $table->string('license_holder_last_name', 100)->nullable(false)->change();
            $table->string('license_holder_first_name', 100)->nullable(false)->change();
            $table->string('license_holder_last_name_kana', 100)->nullable(false)->change();
            $table->string('license_holder_first_name_kana', 100)->nullable(false)->change();
        });
    }
